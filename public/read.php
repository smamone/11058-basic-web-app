...
<section class="section">
    ...
    <?php  
        ...
        <div class="sort">
            <ul>
                <p>Sort results by: </p>
                <li><a href="read.php?sort=title">TITLE</a></li>
                <li><a href="read.php?sort=director">DIRECTOR</a></li>
                <li><a href="read.php?sort=genre">GENRE</a></li>
                <li><a href="read.php?sort=tv">TV</a></li>
                <li><a href="read.php?sort=release">RELEASE DATE</a></li>
            </ul>
        </div>
